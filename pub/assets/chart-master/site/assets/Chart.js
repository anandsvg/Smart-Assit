...
var Chart = function(context){
	...
	var PolarArea = function(data,config,ctx){
		...
		function calculateDrawingSizes(){
			...
			scaleHeight = maxSize;
			//If the label height is less than 5, set it to 5 so we don't.html have lines on top of each other.
	...
	var Radar = function (data,config,ctx) {
		...
		//If no labels are defined set to an empty array, so referencing length for looping doesn't.html blow up.
