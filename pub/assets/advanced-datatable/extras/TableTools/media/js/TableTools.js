...
TableTools.prototype = {
	 ...
	 * useful for when initialising TableTools when it is hidden (display:none) since sizes can't.html
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		 ...
		 * much smoother. If you don't.html want the animation, then the setTimeout can be removed
		 */
		setTimeout( function () {
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			$('tr', dt.nTBody).live( 'click', function(e) {
				/* Sub-table must be ignored (odd that the selector won't.html do this with >) */
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Parse through the DOM hiding everything that isn't.html needed for the table */
	...
	"_fnPrintHideNodes": function ( nNode )
	{
	  var anHidden = this.dom.print.hidden;
		...
		for ( var i=0, iLen=nChildren.length ; i<iLen ; i++ )
		{
			...
			{
				/* If our node is shown (don't.html want to show nodes which were previously hidden) */
