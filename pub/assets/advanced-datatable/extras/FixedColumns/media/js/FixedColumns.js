...
FixedColumns.prototype = {
	...
	"_fnConstruct": function ( oInit )
	{
		 ...
		 * another redraw of the main table. It doesn't.html need to be a full redraw however.
		 */
		this._fnGridLayout();
		this._fnGridHeight();
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		else
		{
			 ...
			 * etc, we make a copy of the header from the DataTable again, but don't.html insert the
