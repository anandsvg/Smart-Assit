...
$(document).ready( function () {
	// Slightly unusual test set this one, in that we don't.html really care about the DOM
	...
	oTest.fnTest(
		"Single property doesn't.html kill other properties",
		function () {
			fn = table.oApi._fnSetObjectDataFn('test');
	...
	oTest.fnTest(
		"Nested property doesn't.html kill other properties",
		function () {
			fn = table.oApi._fnSetObjectDataFn('test.inner');
