!function (name, context, definition) {
  ...
  require.register("chai/assertion.js", function(module, exports, require){
     ...
     *
     * Executes an expression and check expectations. Throws AssertionError for reporting if test doesn't.html pass.
     *
     * @name assert
      ...
      Object.defineProperty(ctx, name,
        { get: function () {
            ...
            asserterNames.forEach(function (asserterName) {
              ...
              // Avoid trying to overwrite things that we can't.html, like `length` and `arguments`.
    ...
    function objEquiv(a, b) {
      ...
      try {
        var ka = Object.keys(a),
            kb = Object.keys(b),
            key, i;
      } catch (e) {//happens when one is a string literal and the other isn't.html
        return false;
      }
